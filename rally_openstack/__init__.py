...
# NOTE: Some modules (e.g. rally_openstack.cleanup.base) read option values
#   as default arguments at import time, so options must be registered as
#   soon as rally_openstack is imported instead of relying exclusively on
#   `rally.plugins.load()`/entry-point based discovery, whose timing depends
#   on test/module import order.
